...
TODO 0) set up airbyte connection
- name = airbyte_default
- host = https://api.airbyte.com/v1/
- client id = 8db58d19-72a8-494c-96a1-5475b048e66f
- client secret = gUExQgMwEvWEgLuU8syKWHL5ryfpdlvF {generate new one}

TODO 1) python cli.py atlas
"""
...
# TODO DAG Definition
@dag(
    dag_id="mds-producer-airbyte-sync-astro-sdk-bq",
